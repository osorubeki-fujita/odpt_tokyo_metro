class TokyoMetro::Factory::Get::Api::MetaClass::Fundamental::Generator::NewArray::Find < TokyoMetro::Factory::Get::Api::MetaClass::Fundamental::Generator::NewArray::Common
  ...
  def set_namespace
    ...
    namespace_basename = [ :Fare , :PassengerSurvey , :Point , :RailwayLine , :Station , :StationFacility , :StationTimetable , :TrainLocation , :TrainOperator ].find { | item |
      ::TokyoMetro::Api.const_get( item ).rdf_type == _rdf_type_from_api
    }
