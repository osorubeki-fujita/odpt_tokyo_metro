class TokyoMetro::Factory::Convert::Common::Api::StationTimetable::ConvertTerminalStations::Info < TokyoMetro::Factory::Convert::Common::Api::MetaClass::Fundamental::Norma
