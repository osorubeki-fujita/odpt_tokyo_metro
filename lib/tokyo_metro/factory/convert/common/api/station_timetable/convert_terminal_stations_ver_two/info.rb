class TokyoMetro::Factory::Convert::Common::Api::StationTimetable::ConvertTerminalStationsVerTwo::Info < TokyoMetro::Factory::Convert::Common::Api::MetaClass::Fundamental::Normal
