...
# @note {TokyoMetro::Modules::Api::ToFactory::Convert::Patch::StationFacility::EscalatorDirectionAtOtemachi::Generate::Info::BarrierFree::Facility::Escalator}#service_detail の内部で、変数に対し、特異メソッドを追加するために prepend される。
