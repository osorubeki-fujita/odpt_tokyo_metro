class TokyoMetro::Factory::BeforeSeed::Api::TrainTimetable::Info::TrainType < TokyoMetro::Factory::BeforeSeed::Api::MetaClass::Timetables::TrainType
  ...
  def initialize( train_type , railway_line_info_in_db , starting_station_info_in_db , terminal_station_info_in_db , operation_day_in_db )
