class TokyoMetro::Factory::Seed::Api::Station::Info::ConnectingRailwayLine::Info < TokyoMetro::Factory::Seed::Api::Station::Info::Common::Info
  ...
  # @todo prepend される {TokyoMetro::Modules::ToFactory::Api::Convert::Customize::Station::ConnectingRailwayLine::Factory::Seed::Info::ConnectingRailwayLine::Info} で、 railway_line_id の列を廃止する（railway_line_id は station_info_id からアクセスできるようにする）。
  def hash_to_db
    {
