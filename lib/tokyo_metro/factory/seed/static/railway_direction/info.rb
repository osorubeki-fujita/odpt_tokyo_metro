class TokyoMetro::Factory::Seed::Static::RailwayDirection::Info < TokyoMetro::Factory::Seed::Static::MetaClass::Info
  ...
  def railway_line_info_in_db( whole = nil , search_by: @info.railway_line )
    _railway_line_info_in_db = super( whole = nil , search_by: search_by )
    if _railway_line_info_in_db.nil?
      puts "\"#{ @info.railway_line }\" does not exist in db."
      _railway_line_info_in_db = super( whole = nil , search_by: "Undefined" )
      if _railway_line_info_in_db.nil?
        raise "Error: \"Undefined\" does not exist in db."
      end
    end
    _railway_line_info_in_db
  end
