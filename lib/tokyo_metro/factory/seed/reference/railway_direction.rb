module TokyoMetro::Factory::Seed::Reference::RailwayDirection
  ...
  def railway_direction_in_db( _railway_line_info_id = railway_line_info_id , whole = nil , search_by: @info.railway_direction )
    if whole.present?
      whole.find_by( railway_line_info_id: _railway_line_info_id , in_api_same_as: search_by )
    else
      ::Railway::Direction.find_by( railway_line_info_id: _railway_line_info_id , in_api_same_as: search_by )
    end
  end
