class TokyoMetro::Rake::Rails::CheckNamespace::RenameTable::Namespace::MatchGroup
  ...
  include ::TokyoMetro::Rake::Rails::CheckNamespace::RenameTable::Namespace::InfoOfRows
