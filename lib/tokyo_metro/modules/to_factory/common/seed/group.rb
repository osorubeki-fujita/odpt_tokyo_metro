...
# @note {TokyoMetro::Modules::ToFactory::Common::Seed::Hash} , {TokyoMetro::Modules::ToFactory::Common::Seed::List} で使用
module TokyoMetro::Modules::ToFactory::Common::Seed::Group
