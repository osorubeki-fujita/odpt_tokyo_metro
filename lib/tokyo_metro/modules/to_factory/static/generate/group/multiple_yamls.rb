...
module TokyoMetro::Modules::ToFactory::Static::Generate::Group::MultipleYamls
  ...
  module ClassMethods
    ...
    # @return [Const (class)]
    # @note
    #   原則として、このモジュール {TokyoMetro::Modules::ToFactory::Static::Generate::Group::OneYaml} が include されているクラスのクラスメソッド factory_for_generating_from_saved_file（クラスを表す定数）が呼び出される。
    #   必要であればサブクラスで上書きする。
