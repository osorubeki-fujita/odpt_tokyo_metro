module TokyoMetro::Modules::Decision::MetaClass::TerminalStation
  ...
  ::TokyoMetro::Modules::Dictionary::Common::Station::StringInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_at_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::Modules::Dictionary::Common::Station::StringInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  ::TokyoMetro::Modules::Dictionary::Common::Station::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_at_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::Modules::Dictionary::Common::Station::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  ::TokyoMetro::Modules::Dictionary::Common::RailwayLine::RegexpInfo.constants( false ).each do | const_name |
    eval <<-DEF
      def terminating_on_#{ const_name.downcase }?
        bound_for?( ::TokyoMetro::Modules::Dictionary::Common::RailwayLine::RegexpInfo.#{ const_name.downcase } )
      end
    DEF
  ...
  def terminating_on_marunouchi_branch_line_including_invalid?
    bound_for?( ::TokyoMetro::Modules::Dictionary::Common::Station::StringList.between_honancho_and_nakano_sakaue_including_invalid )
  end
