module TokyoMetro::Modules::Api::ToFactory::Convert::Customize::TrainTimetable::ToeiMitaLine::Info
  ...
  def convert_station_name_of_toei_mita_line
    if toei_mita_line_train_including_on_namboku_line?
      replace_station_name( ::TokyoMetro::Modules::Api::ToFactory::Convert::Customize::Dictionary::RegexpForReplace.namboku_and_toei_mita_line_common_stations , "Toei.Mita" )
    end
  end
