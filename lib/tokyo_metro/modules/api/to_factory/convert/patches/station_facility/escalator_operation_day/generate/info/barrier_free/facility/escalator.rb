...
# @note {TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorOperationDay.set_modules} により {TokyoMetro::Factory::Generate::Api::StationFacility::Info::BarrierFree::Info::Facility::Escalator} へ include する。
# @note {TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorOperationDay::Generate::Info::BarrierFree::Facility::Escalator::ServiceDetail::ChiyodaKasumigasekiOutsideEscalators} は、TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorDirection::Generate::Info::BarrierFree::Facility::Escalator#service_detail の内部変数に対し、特異メソッドを追加するために prepend される。
module TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorOperationDay::Generate::Info::BarrierFree::Facility::Escalator
  ...
  def service_details
    ...
    when CHIYODA_KASUMIGASEKI_OUTSIDE_ESCALATOR_4 , CHIYODA_KASUMIGASEKI_OUTSIDE_ESCALATOR_5
      ...
      module_name = ::TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorOperationDay::Generate::Info::BarrierFree::Facility::Escalator::ServiceDetail::ChiyodaKasumigasekiOutsideEscalators
    ...
    when GINZA_AKASAKA_MITSUKE_OUTSIDE_ESCALATOR_1
      ...
      module_name = ::TokyoMetro::Modules::Api::ToFactory::Convert::Patches::StationFacility::EscalatorOperationDay::Generate::Info::BarrierFree::Facility::Escalator::ServiceDetail::GinzaAkasakaMitsukeOutsideEscalator
      service_details_after_prepending_patch_module( proc_for_deciding_invalidity , module_name )
