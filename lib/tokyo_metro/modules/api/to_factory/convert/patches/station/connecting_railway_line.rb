module TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine
  ...
  # @note
  #   {TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine::Info} is prepend
  #     to {TokyoMetro::Api::Station::Info} by this method.
  def self.set_modules

    ::TokyoMetro::Api::Station::Info.class_eval do
      prepend ::TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine::Info
    end
