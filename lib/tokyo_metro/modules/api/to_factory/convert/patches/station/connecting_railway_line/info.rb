...
#     by {TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine.set_modules} .
module TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine::Info
  ...
  def initialize( *args )
    ...
    convert_and_delete_connecting_railway_lines(
      ignored: ::TokyoMetro::Modules::Api::ToFactory::Convert::Patches::Station::ConnectingRailwayLine.ignored_railway_lines
    )
  end
