...
# @note prepend {TokyoMetro::Modules::Api::ToFactory::Convert::Patch::StationFacility::EscalatorDirection::Generate::Info::BarrierFree::Facility::Escalator} in {TokyoMetro::Factory::Generate::Api::StationFacility::Info::Platform::Info::SurroundingArea::Info}
