module TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::List
  ...
  def move_station_time_infos_from_invalid_fukutoshin_line_trains_in_yurakucho_line
    ...
    invalid_trains.each do | invalid_train |
      ...
      valid_station_times = ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine.factory_of_valid_station_times_of_weekdays.valid_station_times_of_weekdays( invalid_train , valid_train )
