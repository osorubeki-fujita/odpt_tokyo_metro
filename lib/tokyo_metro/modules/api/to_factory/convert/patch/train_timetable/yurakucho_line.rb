module TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine
  ...
  def self.factory_of_valid_station_times_of_weekdays
    ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::Factory::ValidStationTimesOfWeekdays
  end
  ...
  def self.set_modules
    ::TokyoMetro::Api::TrainTimetable::List.class_eval do
      include ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::List
    end

    ::TokyoMetro::Api::TrainTimetable::Info.class_eval do
      include ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::Info
    end

    ::TokyoMetro::Api::TrainTimetable::Info::StationTime::List.class_eval do
      include ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::Info::StationTime::List
    end

    ::TokyoMetro::Api::TrainTimetable::Info::StationTime::Info.class_eval do
      include ::TokyoMetro::Modules::Api::ToFactory::Convert::Patch::TrainTimetable::YurakuchoLine::Info::StationTime::Info
    end
