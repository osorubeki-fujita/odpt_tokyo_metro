  ...
  describe TokyoMetro::Api do
    ...
    describe "\#.get" do
      ...
      it "returns an instance of \'TokyoMetro::Api::Point::Info\'." do
        ...
        point = ::TokyoMetro::Api.get( ::HTTPClient.new , point_id_urn , parse_json: true , generate_instance: true )
      ...
      it "returns an instance of \'TokyoMetro::Api::Fare::Info\'." do
        ...
        fare = ::TokyoMetro::Api.get( ::HTTPClient.new , fare_id_urn , parse_json: true , generate_instance: true )
      ...
      it "returns an instance of \'TokyoMetro::Api::PassengerSurvey::Info\'." do
        ...
        passenger_survey = ::TokyoMetro::Api.get( ::HTTPClient.new , passenger_survey_id_urn , parse_json: true , generate_instance: true )
      ...
      it "returns an instance of \'TokyoMetro::Api::Station::Info\'." do
        ...
        station = ::TokyoMetro::Api.get( ::HTTPClient.new , station_id_urn , parse_json: true , generate_instance: true )
      ...
      it "returns an instance of \'TokyoMetro::Api::StationFacility::Info\'." do
        ...
        station_facility = ::TokyoMetro::Api.get( ::HTTPClient.new , station_facility_id_urn , parse_json: true , generate_instance: true )
      ...
      it "returns an instance of \'TokyoMetro::Api::TrainTimetable::Info\'." do
        ...
        train_timetable = ::TokyoMetro::Api.get( ::HTTPClient.new , train_timetable_id_urn , parse_json: true , generate_instance: true )
    ...
    describe "\#.get_geo" do
      ...
      it "returns an instance of \'TokyoMetro::Api::Point::Info\'." do
        point_id_urn = "urn:ucode:_00001C000000000000010000030C40CF"
        point = ::TokyoMetro::Api.get_geo( ::HTTPClient.new , point_id_urn , parse_json: true , generate_instance: true )
        expect( point.first ).to be_instance_of( ::TokyoMetro::Api::Point::Info )
      end

      it "returns an instance of \'TokyoMetro::Api::Station::Info\'." do
        station_id_urn = "urn:ucode:_00001C000000000000010000030C4703"
        station = ::TokyoMetro::Api.get_geo( ::HTTPClient.new , station_id_urn , parse_json: true , generate_instance: true )
        expect( station.first ).to be_instance_of( ::TokyoMetro::Api::Station::Info )
      end
      ...
      it "returns an instance of \'TokyoMetro::Api::MlitStation::Info\'." do
        ...
        mlit_station = ::TokyoMetro::Api.get_geo( ::HTTPClient.new , mlit_station_id_urn , parse_json: true , generate_instance: true )
