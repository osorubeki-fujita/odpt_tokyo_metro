def static_railway_line_infos
  ...
  railway_line_infos_in_db = [
    ...
    ["odpt.Railway:Tobu.Isesaki.Hanzomon", "スカイツリーライン・伊勢崎線（半蔵門線直通）", "Skytree and Isesaki Line (through to Hanzomon Line)", "東武スカイツリーライン・伊勢崎線（半蔵門線直通）", "Tobu Skytree and Isesaki Line (through to Hanzomon Line)", "東武スカイツリーライン・伊勢崎線（半蔵門線直通）", "Tobu Skytree and Isesaki Line (through to Hanzomon Line)", "tobu_isesaki_hanzomon"],
    ["odpt.Railway:Tobu.Nikko.Hanzomon", "スカイツリーライン・日光線（半蔵門線直通）", "Skytree and Nikko Line (through to Hanzomon Line)", "東武スカイツリーライン・日光線（半蔵門線直通）", "Tobu Skytree and Nikko Line (through to Hanzomon Line)", "東武スカイツリーライン・日光線（半蔵門線直通）", "Tobu Skytree and Nikko Line (through to Hanzomon Line)", "tobu_nikko_hanzomon"],
    ["odpt.Railway:Tobu.Nikko.Hibiya", "スカイツリーライン・日光線（日比谷線直通）", "Skytree and Nikko Line (through to Hibiya Line)", "東武スカイツリーライン・日光線（日比谷線直通）", "Tobu Skytree and Nikko Line (through to Hibiya Line)", "東武スカイツリーライン・日光線（日比谷線直通）", "Tobu Skytree and Nikko Line (through to Hibiya Line)", "tobu_nikko_hibiya"],
