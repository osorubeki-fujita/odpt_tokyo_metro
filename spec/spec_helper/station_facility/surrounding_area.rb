...
def station_facility_surrounding_area
  ...
  platform_infos_containing_invalid_surrounding_area = surrounding_area_infos.select { | info | dict.keys.include?( info.area_name ) }
  platform_infos_containing_valid_surrounding_area = surrounding_area_infos.select { | info | dict.values.include?( info.area_name ) }
