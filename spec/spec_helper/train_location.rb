def train_location
 ...
 "odpt:trainOwner"=>"odpt.TrainOwner:Toei"}
  ...
  h3 = {"@context"=>"http://vocab.tokyometroapp.jp/context_odpt_Train.jsonld",
 "@type"=>"odpt:Train",
 "@id"=>"urn:ucode:_00001C000000000000010000030DAF78",
 "dc:date"=>"2015-06-30T11:38:01+09:00",
 "dct:valid"=>"2015-06-30T11:39:31+09:00",
 ...
 "odpt:trainOwner"=>"odpt.TrainOwner:Toei"}
  ...
  train_location_of_toei_mita_line_1 = ::TokyoMetro::Factory::Generate::Api::TrainLocation::Info.process( h1 )
  train_location_of_toei_mita_line_2 = ::TokyoMetro::Factory::Generate::Api::TrainLocation::Info.process( h2 )
  train_location_of_toei_mita_line_3 = ::TokyoMetro::Factory::Generate::Api::TrainLocation::Info.process( h3 )
  ...
  describe TokyoMetro::Api::TrainLocation::Info do
    it "is converted if it is on Toei Mita Line." do
      ...
      expect( train_location_of_toei_mita_line_3.train_type ).to eq( "odpt.TrainType:Toei.Express" )
    end
  end
