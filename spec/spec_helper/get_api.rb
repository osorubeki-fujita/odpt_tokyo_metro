def get_api
  describe TokyoMetro::Api do
    ...
    it "should be an instance of \'TokyoMetro::Api::Fare::Info\'." do
    ...
    it "should be an instance of \'TokyoMetro::Api::PassengerSurvey::Info\'." do
    ...
    it "should be an instance of \'TokyoMetro::Api::StationFacility::Info\'." do
    ...
    it "should be an instance of \'TokyoMetro::Api::TrainTimetable::Info\'." do
    ...
    it "should be an instance of \'TokyoMetro::Api::StationTimetable::Info\'." do
